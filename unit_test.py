...
class TestCalculator(unittest.TestCase):
    ...
    def test_subtraction(self):
        response = self.client.post("/basicCalculation", data={
            "num1": "10", "num2": "4", "operation1": "subtract"
        })
    ...
    def test_multiplication(self):
        response = self.client.post("/basicCalculation", data={
            "num1": "3", "num2": "7", "operation1": "multiply"
        })
    ...
    def test_division(self):
        response = self.client.post("/basicCalculation", data={
            "num1": "20", "num2": "4", "operation1": "division"
        })
    ...
    def test_division_by_zero(self):
        response = self.client.post("/basicCalculation", data={
            "num1": "10", "num2": "0", "operation1": "division"
        })
    ...
    def test_invalid_input_basic(self):
        response = self.client.post("/basicCalculation", data={
            "num1": "abc", "num2": "10", "operation1": "add"
        })
